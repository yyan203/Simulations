...
class FixIndent : public Fix {
 ...
 private:
  ...
  int cdim,varflag;
  int nlevels_respa;
  //Fenglin add new variable "tangle"
  double tangle;
  double kfrict;
  double PI;
  double indentation_v;//indentation speed, use absolute value and system unit
  //double indentation_vy;//indentation speed, use absolute value and system unit
  int idim,iaxis,idir; // idir is +1/-1 depending on whether it is approaching or retracting
